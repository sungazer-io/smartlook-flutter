...
// MARK: - Custom navigation events
 ...
 + (void)tractNavigationEventWithControllerId:(nonnull NSString *)controllerId type:(nonnull SLNavigationType)type NS_SWIFT_NAME(tractNavigationEvent(withControllerId:type:));
